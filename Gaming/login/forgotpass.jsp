                ...
                <div class="wrap-login100 p-t-85 p-b-20">
                    <form class="login100-form validate-form" action="forgotpass" method="POST">
                        <span class="login100-form-avatar">
                            <img src="static/images/icon/forgot.png" style="width: 100%" alt="AVATAR">
                        </span>
                        ...
                        <div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Nhập tên đăng nhập">
                            ...
                            <input class="input100" type="text" name="username" value="${user}">
                        </div>

                        <div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Nhập địa chỉ email">
