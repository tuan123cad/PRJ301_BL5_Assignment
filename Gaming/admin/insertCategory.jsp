            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-700" style="text-align: center;">Thêm mới danh mục</h1>
                            ...
                            <div class="col-md-6">
                                <form action="admin-category?action=insert" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="catename" placeholder="Nhập tên danh mục" value="${name}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group" style="text-align: center; border-radius: 5px;">
                                        <input type="submit" name="submit" class="btn btn-facebook" value="Thêm danh mục">
                                    </div>
                                </form>
                            </div>
                            <div class="col-md-3"></div>
