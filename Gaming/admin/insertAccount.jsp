                ...
                <div id="content">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <form action="admin-account?action=insert" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="username" placeholder="Thêm tài khoản" value="${username}">
                                    </div>
                                    <div class="form-group">
                                        <label for="password">Mật khẩu</label>
                                        <input type="text" class="form-control" name="password" placeholder="Nhập mật khẩu" value="${password}">
                                    </div>
                                    <div class="form-group">
                                        <label for="displayName">Tên hiển thị</label>
                                        <input type="text" class="form-control" name="displayname" placeholder="Nhập tên hiển thị" value="${displayName}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="email" placeholder="Nhập địa chỉ email" value="${email}">
                                    </div>
                                    <div class="form-group">
                                        <label for="phone">Số điện thoại</label>
                                        <input type="text" class="form-control" name="phone" placeholder="Nhập số điện thoại" value="${phone}">
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <c:forEach items="${listRoleAccount}" var="roleAccount">
                                                <c:choose>
                                                    <c:when test="${roleAccount.id==listRoleAccount.size()}">
                                                        <input type="radio" name="role" value="${roleAccount.id}" ${role==roleAccount.id?"checked":""}>${roleAccount.role}
                                                    </c:when>
                                                    <c:otherwise>
                                                        <input type="radio" name="role" value="${roleAccount.id}" ${role==roleAccount.id?"checked":""}>${roleAccount.role}<br/>
                                                    </c:otherwise>
                                                </c:choose>
