            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-700" style="text-align: center;">Thêm mới danh mục con</h1>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <form action="admin-subcategory?action=insert" method="POST">
                                    ...
                                    <div class="form-group mt-4">
                                        ...
                                        <select name="cate">
                                            <c:forEach items="${listCategories}" var="category" varStatus="track">
                                                <option value="${category.id}" ${cate==category.id?"selected":""}>${category.categoryName}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="subCateName">Tên danh mục con</label>
                                        <input type="text" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="subcatename" placeholder="Nhập tên danh mục con" value="${name}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group" style="text-align: center; border-radius: 5px;">
                                        <input type="submit" name="submit" class="btn btn-facebook" value="Thêm danh mục con">
                                    </div>
                                </form>
                            </div>
                            <div class="col-md-3"></div>
