                ...
                <div id="content">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <form action="admin-image?action=insert&id=${prodId}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="imageUrl" id="exampleInputEmail1" aria-describedby="imageUrl" placeholder="Nhập url ảnh của sản phẩm" value="${imageUrl}">
                                    </div>
